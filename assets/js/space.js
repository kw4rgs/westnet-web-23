    ...
    Game.prototype = {
        ...
        draw: function () {
            if (this.lost) {
                ...
                screen.font = "50px Silkscreen";
                screen.textAlign = "center";
                screen.fillStyle = "black";
                screen.fillText("¡Oops.. ha perdido el descuento! :(", gameSize.width / 2, gameSize.height / 2);
                screen.font = "20px Silkscreen";
                screen.fillText(
                    "Descuento del " + kills + "% perdido",
                    gameSize.width / 2,
